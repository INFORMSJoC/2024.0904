...
{
public:
    Graph1* graph1; // get after building G1
    ...
    LBBD_Info() : LBBD_iter(1), MP_status(1), SP_status(-1), OP_status(-1), UB(1000000), LB(1e-3), obj_MP(-1), obj_SP(-1),
        ...
        LB_delta_obj(0.0), LB_delta_time(0.0),
        Heu_sp(0), lbbd_gap(-1), mp_gap(0.0), sp_gap(-1),
        Kahn_Heu(0), Kahn_SP2(0), graph1(nullptr), lastSP(nullptr) {}
    ...
    //LBBD_Info() : LBBD_iter(0), MP_status(-1), SP_status(-1), OP_status(-1), UB(100000), LB(1e-3), obj_MP(0.0), obj_SP(0.0),
    //    total_SP_solved(0), total_time_SP(0.0),
    //    total_lazy1(0), total_lazy2(0), total_lazy3(0),
    //    total_num_SP2_solved(0), total_time_SP2(0.0), total_num_SP2_NogoodCut(0), total_time_MP(0.0), Total_time(0.0), Heu_sp(0),
    //    lbbd_cut_opt(-1), lbbd_cut_nogood(-1), lbbd_gap(0.0), sp_gap(0.0), mp_gap(0.0) {}
};
